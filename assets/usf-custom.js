// define templates for the Given theme
var _usfProductPriceTemplate = `
 <template v-if="hasDiscount">
     <span class="product-item__price product-item__price--new" data-money-convertible v-html="displayDiscountedPrice"></span>
     <span class="product-item__price product-item__price--old" data-money-convertible v-html="displayPrice"></span>
 </template>
 <span v-else-if="priceVaries && !product.selectedVariantId" class="product-item__price" v-html="loc.from + ' ' +displayMinDiscountedPrice"></span>
 <span v-else class="product-item__price" data-money-convertible v-html="displayDiscountedPrice"></span>
`;

var _usfProductLabels = `
<div v-if="hasDiscount && usf.settings.search.showSale" class="product-item__label">
    <span class="label label--on-sale" v-html="loc.sale"></span>
</div>
<div v-else-if="isSoldOut && usf.settings.search.showSoldOut" class="product-item__label">
    <span class="label label--sold-out" v-html="loc.soldOut"></span>
</div>
`;
...
<div class="usf-sr-container" :class="{'usf-no-facets': noFacets, 'usf-empty': !loader && !hasResults, 'usf-nosearch': !showSearchBox}">
    ...
    <div :class="(view === \'grid\' ? _usfGridWraperClass : \'list-view-items\') + \' usf-results usf-clear usf-\' + view">
...
<div class="collection__item product-item" :class="[(teaser_size = _usfGetTeaserSize(product)),{'product-item--sold-out':isSoldOut}, _usfGridItemClass]" :key="product.Id" :product-selector="product.id">
    <div class="product-item__inner">
        <div class="product-item__labels">
            <template v-for="tag in product.tags">
                <div v-if="tag.includes('__label')" class="product-item__label">
                    <span class="label label--custom" v-html="tag.split('__label').pop()"></span>
                </div>
            </template>
            `+ _usfProductLabels + `
            <!-- Wishlist -->
            ...
            <div class="product-item__quick-shop">
                <div v-if="!isSoldOut && _usfSectionSettings.show_quick_shop" class="product-item__label product-item__label--hidden">
                    <button class="label label--quick-shop" data-action="open-quick-shop" :data-quick-shop-url="_usfAddQuery(productUrl,'view=quick_shop')" v-html="_usfQSIcon + loc.quickView"></button>
                </div>
            </div>
        </div>
        <a :href="productUrl" @click="onItemClick"  class="product-item__image">
            <div class="product-item__image-wrapper" @mouseover="onItemHover" @mouseleave="onItemLeave">
                <img :src="selectedImageUrl" :alt="product.title">
                <img v-if="teaser_size != 'double' && hoverImageUrl" class="second-product-image" :src="hoverImageUrl" :alt="product.title" />
                <!-- product image extra -->
        ...
        <div class="product-item__info">
            ...
            <h3 v-if="_usfSectionSettings.show_vendor && usf.settings.search.showVendor" class="product-item__vendor">
...
<a class="usf-sr-product list-view-item" @click="onItemClick" @mouseover="onItemHover" @mouseleave="onItemLeave" :href="productUrl" :key="product.id">
    ...
    <div class="list-view-item__title-column">
        ...
        <div v-if="_usfSectionSettings.show_vendor && usf.settings.search.showVendor" class="list-view-item__vendor medium-up--hide" v-html="product.vendor"></div>
        <template v-if="usf.isMobile"> `+ _usfProductPriceTemplate +`</template>
    </div>

    <!-- Vendor, for mobile -->
    <div class="list-view-item__vendor-column small--hide">
        <div v-if="_usfSectionSettings.show_vendor && usf.settings.search.showVendor" class="list-view-item__vendor" v-html="product.vendor"></div>
    </div>
...
`,
    ...
    addToCartPlugin: /*inc_begin_addtocart-plugin*/
        `<form class="usf-add-to-cart" method="POST" enctype="multipart/form-data" :action="usf.platform.addToCartUrl" @submit="e => usf.__addCartAjax(event)">
    <input type="hidden" name="id" :value="variant.id">
    <button :class="{'usf-visible': args.isHover}" type="submit" name="add" class="usf-add-to-cart-btn  usf-ajax-to-cart" :data-product-id="args.product.id"   >
    ...
    <div class="usf-preview">
        ...
        <div class="usf-preview__body">
            ...
            <div class="usf-preview__content-right">
                ...
                <!-- Add to cart form -->
                <form method="post" enctype="multipart/form-data" :action="usf.platform.addToCartUrl"  @submit="e => usf.__addCartAjax(event)">
                    <!-- variant ID -->
                    ...
                    <div class="usf-preview__field">
                        ...
                        <div class="usf-flex usf-preview__add-to-cart">
                            ...
                            <button :data-product-id="product.id"  :title="!hasAvailableVariant ? loc.selectedVariantNotAvailable : ''" :disabled="!hasAvailableVariant" type="submit" name="add" class="usf-preview--add-to-cart-btn usf-ajax-to-cart" :class="{ 'usf-disabled': !hasAvailableVariant}"  >
                                <span class="usf-text" v-html="loc.addToCart"></span>
...
function _usfGetTeaserSize(p) {
    var tag = p.tags.find(t => t.includes('_big'));
    return tag ? 'double' : 'single';
}
...
usf.__addCartAjax = function (e) {
    ...
    //get form data
    var formDdata = new FormData(form);
    var data = '';
    formDdata.forEach(function (value, key) {
        data += (data != '' ? '&' : '') + key + '=' + value + '&';
    });
    ...
    var text = btn.querySelector('.usf-text');
    text.classList.add('animated');
    text.classList.add('zoomOut');
    ...
    function successCallBack() {
        ...
        var closeBtn = document.querySelector('.usf-preview .usf-remove');
        if (closeBtn)
            closeBtn.click();

        setTimeout(function () {
            text.classList.remove('zoomOut');
            text.classList.add('fadeInDown');
    ...
    function errorCallBack(data) {
        ...
        btn.classList.remove('disabled');
        setTimeout(function () {
            text.innerText = usf.settings.translation.addToCart;
        }, 2500);
    }
    function addItem(t, s, e) {
        ...
        xhr.onload = function () {
            ...
            if (status === 200)
                "function" == typeof s ? s(xhr.response) : '';
            else
                "function" == typeof e ? e(xhr.response) : '';
        };
        xhr.send(t);
    }
...
usf.event.add('init', function () {
    ...
    window._usfGridWraperClass = window._usfGridWraperClass || "collection collection--grid grid grid--gallery grid--middle";
    window._usfGridItemClass = window._usfGridItemClass || "grid__cell 1/2 1/4--handheld 1/4--lap-and-up";
    window._usfSectionSettings = window._usfSectionSettings || {
        show_quick_shop: true,
        show_vendor: true
    };
    window._usfQSIcon = window._usfQSIcon || `<svg class="icon icon-cart-empty">
...
usf.event.add(['sr_updated', 'sr_viewChanged', 'rerender'], function () {
    setTimeout(function () {
        var Product_Grid_Image_Height = parseInt(jQuery('.product-item__image-wrapper').width() * 1.40);
